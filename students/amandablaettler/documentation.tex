...
[kurs05@manet Documents] ls
a b 
[kurs05@manet Documents] rename a c a 
                                from
                                  to
                                    file
[kurs05@manet Documents] ls
...
\item[\texttt{cat}] give the text out
\item[\texttt{cat-n}] number all output lines

    \begin{terminalcode}
IMPORTENT COMMENTS
clear  -> clear the displaz
head   -> display first lines of a file
kill   -> kill all running processes with a given file
passwd -> change your accounts password
ping   -> see if a host is online and responds
tail   -> displaz the last part of a file, mostly used for logs
tar    -> used for un- and compressing a file
tee    -> pipe fitting
top    -> displaz and update sorted information about processes
whoami -> displaz effective user id

SVN
svn update up (update the file on the computer)
svn commit ci (update the file on the server)
svn checkout co (takes the file)
svn --help checkout (shows the help for this order)
    \end{terminalcode}
