...
To create a footnote use the \verb$\footnote{Blabla}$ 
...
%============================================================================Ruby zu starten muss man "irb" eingeben. 

Alle Informationen zu Ruby findet man auf der folgenden Webseite:\\

{\center http://www.ruby-lang.org/en/documentation/quickstart/}

\noindent Eine weitere hilfreiche Webseite zu Ruby ist\\

http://pine.fm/LearnToProgram\\

\noindent Das Ruby kann man ganz einfach als Rechner. Z.B : 3+2 oder 3**2 ( 3 hoch 2). Umweitere, kompexere Mathaufgaben loesen zu koennen, muss man"Math." eingeben. z.B "Math.sqrt". Dazu gehoert auch "sin()" und "tan()".

\noindent Mit ``def'' kann man einem Buchstaben(z.b def h) eine Definition zu geben. 
mit puts wird aufgeschrieben wof[r das h definiert werden soll (z.b Hello World)
um diese Definitionsgeschichte zu beenden schreibt man "end"
...
\noindent Mit \#\{name\} ist es moeglich, etwas an dieser Stelle, in den String einzubauen.
...
\noindent Mit dem Befehl ``class'' definiert man eine Klasse namens `` Greeter'' oder ``Megagreter'' und noch weitere andere.


\noindent Das ``@name'' dient dazu mehrer verschiedene Namen, die man vor dem Gebrauch mit ``name='' definiert. es ist von Vorteil dies so zu gebrauchen, da man bei einerAenderung des Namens, bei allen unterstehenden Befehlen aendern muesste.  

\noindent Mit ``g.'' wird der Name gespeichert und der befehl kann ausgefuert werden
