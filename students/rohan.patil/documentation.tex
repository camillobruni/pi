...
\begin{enumerate}
	...
	\item \texttt{cd:}    change directory, wenn man im filesystem, den Ort aendern will
%	\Item \texttt{ls}    listet alle Informationen ueber das file auf
	\item \texttt{pwd:}   zeigt den ganzen Ordnernahem des current woring directory
