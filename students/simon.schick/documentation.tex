...
irb im Terminal eingeben, oeffnet Ruby
Math. fuer mathematische Funktionen, z. B. sqrt (fuer einfache Operationen 3+5 nicht noetig)
def h definiert Methode h, mit end abschliessen (Bauelement)
class H kann mehrere Methoden buendeln, mit end abschliessen (Bauplan) 
class.instance.methodes(false) zeigt alle Methoden; (false) optional, zeigt nur eigene Methoden
attr_accessor erlaubt das hinzufuegen von Methoden
g = Klassennamen.new(...) definiert Objekt (Gebautes)
objektname.respond_to?("methodenname") ueberprueft die anwendbarkeit
exit oder quit oder ctrl d zum verlassen von Ruby
