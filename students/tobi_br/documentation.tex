...
\item \texttt{"grep" did not get that}
\item \texttt{"less" could not do without previous example}
...
\item \texttt{ ";" seperates two commands in a line. With && between one command and the other the following command gets executed only if command 1 was successful.}
